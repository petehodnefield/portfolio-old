...
const backEndProjects = [
  ...
  {
    title: "DEI Calendar",
    description: `An events calendar for a business to use to provide diverse events to their employees.`,
    github: "https://github.com/petehodnefield/project-three",
    live_deployment: "https://serene-mesa-60189.herokuapp.com/",
    image: "./assets/images/DEICalendar.png",
    image_alt: "My project DEI Calendar",
    tech_used: [
      "HTML",
      "CSS",
      "JavaScript",
...
window.addEventListener("load", (e) => {
  generateFrontEndProjects(), generateBackEndProjects();
});
